function [vectProbOrdered,order,ordervalue]=aux_ordenar_lib(vect_TR,vectProb,np)
...
[pixel nb]=size(vect_TR_3);
vect_TR_3_2=reshape(vect_TR_3,pixel,nb);
for i=classes
